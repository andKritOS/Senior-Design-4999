...
def detectStopLines():
    ...
    global corners,frameFilterCorners
    ...
    cv.imshow("Frame",frameFilterCorners)
...
def detectLEDS():
    ...
    cv.imshow("yellowLEDPixels", yellowLEDPixels)group20_FourB@piFour:~/Documents/4999Code/venv/program $ ^C
group20_FourB@piFour:~/Documents/4999Code/venv/program $ 
    elif(cX > w_half):
        print("Right light detected")
        sensorData.rightLightDetected = True
    else:
