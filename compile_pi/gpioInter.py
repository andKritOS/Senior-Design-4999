...
#-----BUMPER SWITCHES
#Pin initialization
gpioALT.setmode(gpioALT.BCM)
gpioALT.setup(pinAsgn["leftBumper"[0]],gpioALT.IN)
gpioALT.setup(pinAsgn["centerBumper"[0]],gpioALT.IN)
gpioALT.setup(pinAsgn["rightBumper"[0]],gpioALT.IN)

#Callback function
def bumperCallBack():
    print("BUMPER CALLBACK ACTIVATED. UH-OH! \n")
    sensorData.bumperEngaged = True

#Callback Declarations
gpioALT.add_event_detect(pinAsgn["leftBumper"[0]], gpioALT.RISING, callback= bumperCallBack())
gpioALT.add_event_detect(pinAsgn["centerBumper"[0]], gpioALT.RISING, callback= bumperCallBack())
gpioALT.add_event_detect(pinAsgn["rightBumper"[0]], gpioALT.RISING, callback= bumperCallBack())

#Left Bumper Switch
#bumperSWL = gpioALT.Button(pin= pinAsgn["leftBumper"[0]])
